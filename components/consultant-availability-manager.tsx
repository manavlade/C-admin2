...
export function ConsultantAvailabilityManager({ consultantId, consultantName }: ConsultantAvailabilityManagerProps) {
  ...
  const handleSaveWeeklyAvailability = () => {
    ...
    toast({
      ...
      description: `Availability for ${consultantName} has been updated.`,
    })
