...
interface ConsultantAvailabilityCalendarProps {
  consultantId: string
  consultantName: string
}

export function ConsultantAvailabilityCalendar({ consultantId, consultantName }: ConsultantAvailabilityCalendarProps) {
  ...
  const handleSaveAvailability = () => {
    ...
    toast({
      ...
      description: `Availability for ${consultantName} on ${format(date, "PPP")} from ${startTime} to ${endTime} (${isOnline ? "Online" : "Offline"}) has been saved.`,
    })
    ...
    <div className="grid gap-6 md:grid-cols-2">
      ...
      <div className="flex flex-col gap-4">
        ...
        <p className="text-muted-foreground">
          This section would display the consultant's already saved availability slots for the selected month/date. You
